  ...
  const stages = [
    {
      ...
      length:5600, speed:366, gravityFlip:false,
      obstacles:[
        O(620,'spike',0,86,34),C(880,0),R(1190,58,165),O(1460,'wall',1,64,155),
        D(1760,0,285,105,2.25,.4),R(2050,58,190),C(2300,1),O(2550,'spike',1,100,34),
        O(2840,'wall',0,66,168),R(3160,62,180),D(3470,1,270,115,2.55,1.6),C(3740,0),
        O(4030,'spike',0,108,34),R(4330,60,205),O(4640,'wall',1,70,178),C(4910,1),
        R(5200,62,170),O(5430,'spike',0,90,34)
      ]
    },
    {
      abs:10, act:'ACT III — FRACTURE', name:'CROSS CURRENT',
      hint:'Gravity flips on Pulse. The rift timing stays the same.',
      length:5900, speed:378, gravityFlip:true,
      obstacles:[
        O(650,'wall',0,60,128,'floor'),R(980,56,155,'ceiling'),C(1260,1,'ceiling'),
        O(1550,'spike',1,92,34,'ceiling'),O(1840,'wall',0,64,150,'floor'),R(2140,60,180,'floor'),
        D(2440,1,270,115,2.5,.8),C(2690,0,'floor'),O(2980,'wall',1,68,165,'ceiling'),
        R(3300,60,190,'ceiling'),O(3600,'spike',0,104,34,'floor'),C(3890,1,'ceiling'),
        D(4200,0,290,105,2.75,2.0),R(4510,62,180,'floor'),O(4820,'wall',1,70,178,'ceiling'),
        O(5160,'spike',0,112,34,'floor'),R(5480,62,200,'ceiling'),C(5730,1,'ceiling')
      ]
    },
    {
      ...
      length:6200, speed:390, gravityFlip:false,
      obstacles:[
        E(680,280,95,2.2,1.35,.1),O(980,'spike',0,96,34),C(1230,0),E(1510,300,110,2.5,1.1,.7),
        R(1810,58,180),O(2110,'wall',1,66,170),E(2420,260,120,2.7,.95,1.4),C(2670,1),
        O(2940,'spike',1,108,34),R(3240,60,195),E(3540,305,100,2.85,1.05,2.3),
        O(3840,'wall',0,70,180),C(4120,0),E(4420,270,125,3.0,.9,3.0),R(4720,62,205),
        O(5040,'spike',0,116,34),E(5360,295,110,3.1,.85,.4),O(5650,'wall',1,72,175),C(5960,1)
      ]
    },
    {
      ...
      length:7000, speed:405, gravityFlip:false, boss:true, bossRequired:5, voidChase:true,
      obstacles:[
        O(590,'spike',0,92,34),E(850,285,100,2.55,1.1,.2),B(1110,0),R(1380,58,180),
        O(1660,'wall',1,68,170),B(1930,1),D(2190,0,295,115,2.7,1.0),O(2480,'spike',0,110,34),
        R(2760,60,195),B(3040,0),E(3320,270,120,2.9,.95,1.9),O(3620,'wall',1,70,185),
        B(3910,1),R(4190,62,210),O(4480,'spike',1,118,34),D(4770,0,300,120,3.0,.4),
        B(5060,0),S(5280),O(5530,'wall',1,74,190),R(5850,64,205),E(6150,285,125,3.1,.82,2.7),
        O(6460,'spike',0,120,34),O(6740,'wall',1,74,178)
      ]
    },
    {
      abs:13, act:'ACT IV — COLLAPSE', name:'REDLINE',
      hint:'The system stops teaching. Keep the rhythm or get erased.',
      length:6400, speed:420, gravityFlip:false,
      obstacles:[
        R(610,56,170),O(870,'spike',0,96,34),E(1130,285,110,2.8,1.0,.2),O(1390,'wall',1,68,175),
        R(1680,58,195),D(1950,0,300,115,3.0,1.1),C(2200,0),O(2440,'spike',1,112,34),
        E(2730,260,125,3.1,.9,2.0),R(3020,60,200),O(3310,'wall',0,70,188),C(3560,1),
        O(3820,'spike',0,120,34),R(4100,62,210),E(4390,300,120,3.2,.8,.6),O(4690,'wall',1,72,190),
        D(4970,0,275,130,3.25,2.4),R(5260,64,215),O(5560,'spike',1,124,34),C(5840,1),
        R(6100,62,190)
      ]
    },
    {
      ...
      length:6600, speed:428, gravityFlip:false, blackout:true,
      obstacles:[
        C(620,0),R(900,58,185),E(1190,280,115,2.8,1.05,.2),O(1490,'spike',0,108,34),
        O(1780,'wall',1,70,180),R(2070,60,205),E(2370,300,120,3.0,.9,1.5),S(2610),
        O(2860,'spike',1,118,34),R(3150,62,215),D(3440,0,280,130,3.1,.7),C(3690,1),
        O(3960,'wall',0,72,190),E(4250,265,125,3.2,.82,2.6),R(4540,64,210),
        O(4840,'spike',0,122,34),D(5130,1,300,125,3.3,2.0),R(5420,64,220),
        O(5720,'wall',1,76,192),E(6020,285,130,3.35,.75,.4),C(6310,0)
      ]
    },
    {
      abs:15, act:'ACT IV — COLLAPSE', name:'NO RETURN',
      hint:'The collapse is behind you now. Perfect Pulses push it back.',
      length:7200, speed:440, gravityFlip:true, voidChase:true,
      obstacles:[
        O(590,'spike',0,100,34),R(860,58,185,'ceiling'),E(1150,275,115,3.0,.92,.1),
        O(1440,'wall',1,70,178,'floor'),C(1690,1,'floor'),R(1970,60,205,'floor'),
        D(2260,0,295,125,3.15,1.2),O(2560,'spike',0,116,34,'ceiling'),R(2850,62,215,'ceiling'),
        O(3150,'wall',1,72,190,'floor'),S(3400),E(3690,265,130,3.3,.8,2.1),
        R(3980,64,220,'floor'),O(4280,'spike',1,124,34,'ceiling'),C(4550,0,'ceiling'),
        D(4840,1,300,130,3.4,2.6),R(5140,64,215,'ceiling'),O(5450,'wall',0,74,195,'floor'),
        E(5750,280,135,3.45,.72,.6),R(6060,66,225,'floor'),O(6370,'spike',0,128,34,'ceiling'),
        O(6670,'wall',1,76,198,'floor'),R(6960,64,210,'ceiling')
      ]
    },
    {
      abs:16, act:'ACT IV — COLLAPSE', name:'EVENT HORIZON',
      hint:'Hunter Prime. Eight cores. Every mechanic. One clean exit.',
      length:8600, speed:452, gravityFlip:false, boss:true, bossRequired:8, finalBoss:true, voidChase:true,
      obstacles:[
        O(560,'spike',0,104,34),E(820,285,120,3.1,.9,.2),B(1080,0),R(1340,58,190),
        O(1610,'wall',1,70,185),B(1880,1),D(2140,0,300,125,3.2,.8),O(2420,'spike',0,118,34),
        R(2700,60,210),B(2980,0),E(3260,270,130,3.35,.78,1.5),O(3560,'wall',1,72,195),
        B(3840,1),R(4120,62,220),O(4410,'spike',1,124,34),D(4700,0,295,135,3.45,2.0),
        B(4990,0),S(5210),E(5480,265,135,3.55,.7,.4),R(5770,64,225),
        O(6070,'wall',1,76,200),B(6360,1),O(6650,'spike',0,130,34),D(6940,1,305,130,3.6,1.0),
        B(7230,0),R(7520,66,230),E(7810,280,140,3.65,.65,2.5),B(8080,1),
        O(8320,'spike',1,132,34)
      ]
    }
  ];
